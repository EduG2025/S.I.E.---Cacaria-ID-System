...
// import { api } from "./api"; // API Key management via DB is deprecated
...
const getAI = async () => {
  ...
  if (!apiKey) throw new Error("API_KEY_MISSING: API Key must be set in environment variables (process.env.API_KEY).");
