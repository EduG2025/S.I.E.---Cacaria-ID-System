      ...
      <div ref={idRef} className="w-[350px] h-[220px] bg-white rounded-xl overflow-hidden shadow-2xl relative flex flex-col print:shadow-none font-sans select-none border border-gray-100">
        ...
        <div className="flex flex-row p-2 gap-3 relative z-10 h-full">
          ...
          <div className="flex flex-col items-center gap-1.5 mt-1">
            <div className="w-20 h-24 border-2 border-green-700 rounded-md overflow-hidden relative shadow-sm bg-gray-100 shrink-0">
              {renderPhoto()}
            </div>
            <div className="w-20">
                <input 
                    ...
                    className="text-[8px] font-bold text-white bg-green-800 rounded-full uppercase shadow-sm text-center w-full outline-none border border-transparent focus:border-white py-0.5"
                />
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-start gap-1 mt-0.5 min-w-0 pr-1">
            <div className="mb-0.5">
              ...
              <input 
                ...
                className={`${inputBaseClass} text-[11px] font-bold text-gray-900 leading-none font-mono uppercase truncate h-4`}
              />
            </div>
  
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="block text-[6px] text-gray-500 uppercase font-bold leading-none mb-0.5">RG</label>
                <input 
                    value={resident.rg}
                    onChange={(e) => handleChange('rg', e)}
                    placeholder="00.000.000-0"
                    className={`${inputBaseClass} text-[9px] font-semibold text-gray-800 font-mono h-3.5`}
                />
              </div>
              <div>
                 <label className="block text-[6px] text-gray-500 uppercase font-bold leading-none mb-0.5">Nascimento</label>
                 <input 
            ...
            <div>
              <label className="block text-[6px] text-gray-500 uppercase font-bold leading-none mb-0.5">CPF</label>
              <input 
                    value={resident.cpf}
             ...
             <div className="mt-auto pb-5 flex flex-col items-end">
               ...
               <input 
                   value={mandateText} 
                   readOnly 
                   className="text-[6px] font-bold text-green-800 uppercase bg-green-100/60 px-1.5 rounded w-fit leading-tight text-right border-none bg-transparent"
               />
            </div>
          </div>
        </div>
    ...
    return (
        <div ref={idRef} className="w-[350px] h-[220px] bg-slate-900 rounded-xl overflow-hidden shadow-2xl relative flex flex-row print:shadow-none text-white font-sans border border-slate-700 select-none">
            ...
            <div className="w-22 h-full bg-blue-600 relative flex flex-col items-center pt-3 z-10 shrink-0 shadow-lg">
                 ...
                 <div className="w-16 h-20 bg-white rounded-lg overflow-hidden border-2 border-white shadow-lg mx-auto mb-2">
                    {renderPhoto()}
                 </div>
                 <div className="mt-auto mb-4 -rotate-90 whitespace-nowrap text-[7px] font-bold tracking-[0.2em] text-blue-200">
                    IDENTIDADE
                 </div>
            </div>
            ...
            <div className="flex-1 p-3 flex flex-col relative z-10 overflow-hidden min-w-0">
                ...
                <div className="z-10 mb-2 border-b border-blue-500/30 pb-2">
                    ...
                    <div>
                      <input 
                          ...
                          className="bg-transparent border-none text-[12px] font-bold text-white uppercase leading-none w-full focus:ring-1 focus:ring-blue-500 rounded px-1 truncate h-5"
                      />
                    </div>
                </div>
                ...
                <div className="z-10 grid grid-cols-2 gap-x-2 gap-y-2 mt-1">
                    <div>
                        <h3 className="text-gray-500 text-[5px] font-bold uppercase leading-none mb-0.5">Função</h3>
                        <input 
                            value={resident.role}
                            onChange={(e) => handleChange('role', e)}
                            className="bg-blue-900/40 border border-blue-800/50 text-[8px] font-semibold text-blue-200 w-full rounded px-1.5 py-0.5 leading-tight truncate"
                        />
                    </div>
                     <div>
                        <h3 className="text-gray-500 text-[5px] font-bold uppercase leading-none mb-0.5">Nascimento</h3>
                        <input 
                            value={resident.birthDate}
                            onChange={(e) => handleChange('birthDate', e)}
                            className="bg-transparent border-none text-[9px] font-mono text-white w-full border-b border-blue-500/30 px-0 leading-tight"
                        />
                    </div>
                    <div>
                        <h3 className="text-gray-500 text-[5px] font-bold uppercase leading-none mb-0.5">CPF</h3>
                        <input 
                            value={resident.cpf}
                            onChange={(e) => handleChange('cpf', e)}
                            className="bg-transparent border-none text-[9px] font-mono text-gray-300 w-full border-b border-blue-500/30 px-0 leading-tight"
                        />
                    </div>
                     <div>
                        <h3 className="text-gray-500 text-[5px] font-bold uppercase leading-none mb-0.5">RG</h3>
                        <input 
                            value={resident.rg}
                            onChange={(e) => handleChange('rg', e)}
                            placeholder="RG"
    ...
    <div ref={idRef} className="w-[350px] h-[220px] bg-white rounded-lg overflow-hidden shadow-xl border border-gray-200 relative flex flex-col p-2 font-mono select-none">
         ...
         <div className="flex justify-between items-start border-b-2 border-black pb-1 mb-2 relative z-10 shrink-0">
             ...
             <div className="text-right w-1/3 pt-1">
                 <input 
                    value={resident.role}
                    onChange={(e) => handleChange('role', e)}
                    className="text-[9px] font-bold bg-black text-white px-2 py-0.5 text-center w-full outline-none rounded-sm uppercase tracking-wide"
                 />
             </div>
         </div>
         ...
         <div className="flex gap-3 relative z-10 flex-1 min-h-0 mb-1">
             ...
             <div className="flex-1 min-w-0 flex flex-col justify-start gap-1.5 py-0.5">
                 <div>
                     <span className="text-[6px] block text-gray-500 uppercase leading-none mb-0.5">Nome</span>
                     <input 
                        value={resident.name}
                        onChange={(e) => handleChange('name', e)}
                        placeholder="NOME"
                        className="text-[11px] font-bold block leading-none w-full outline-none hover:bg-gray-50 focus:bg-gray-100 bg-white/50 truncate border-b border-gray-200 h-4"
                     />
                 </div>
                 <div>
                     <span className="text-[6px] block text-gray-500 uppercase leading-none mb-0.5">Documento (CPF)</span>
                     <div className="flex gap-1">
                        <input 
                            value={resident.cpf}
                            onChange={(e) => handleChange('cpf', e)}
                            className="text-[10px] block w-full outline-none hover:bg-gray-50 focus:bg-gray-100 bg-white/50 leading-none h-3.5"
                        />
                     </div>
                 </div>
                  <div className="flex justify-between gap-2 mt-1">
                     <div className="flex-1">
                         <span className="text-[6px] block text-gray-500 uppercase leading-none mb-0.5">Nasc.</span>
                         <input 
                            value={resident.birthDate}
                            onChange={(e) => handleChange('birthDate', e)}
                            className="text-[9px] block w-full outline-none hover:bg-gray-50 focus:bg-gray-100 bg-white/50 leading-none h-3.5"
                         />
                     </div>
                      <div className="flex-1 text-right">
                         <span className="text-[6px] block text-gray-500 uppercase leading-none mb-0.5">RG</span>
                         <input 
                            value={resident.rg}
                            onChange={(e) => handleChange('rg', e)}
                            className="text-[9px] block w-full text-right outline-none hover:bg-gray-50 focus:bg-gray-100 bg-white/50 leading-none h-3.5"
                         />
                     </div>
                 </div>
                 <div className="mt-auto pt-1">
                    <p className="text-[6px] font-bold border-t border-dashed border-gray-300 pt-1 text-right">{mandateText}</p>
                 </div>
             </div>
         </div>
