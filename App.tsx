...
// 1. REGISTRATION STATUS PANEL
const RegistrationStatusPanel: React.FC<{ resident: Resident }> = ({ resident }) => {
    const fields = [
...
const ResidentsListView: React.FC<ResidentsListViewProps> = ({ residentsList, onEdit, onDelete, onNew }) => {
...
const UsersListView: React.FC<UsersListViewProps> = ({ systemUsers, refreshUsers }) => {
